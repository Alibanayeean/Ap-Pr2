...
public class Teacher_ChatRoom implements Initializable {

    public static final Logger log = LogManager.getLogger(Teacher_ChatRoom.class);
    ...
    public void updateListCell(){
        ...
        if(isOnPanePage){
            ...
            LinkedList<LinkedList<String>> linkedLists = clientNetwork.getAllStudentForATeacherInChatRoom(teacher.getId(), teacher.getUsername());
