...
public class Teacher_CW_CoursePage_SendText implements Initializable{
    ...
    public void PrintForPane(){
        ...
        if(isExam){
            ...
            for (Map.Entry<Integer, Double> entry : exams.get(index).getStudentsSend_Score().entrySet()) {
                ...
                HelpPrint(name , answer, score, studentsNumber, time, counter, key);
                counter++;
            }
        }
        else{
    ...
    public void HelpPrint(String name, String answer, double score, String studentNumber, String time, int counter, int studentId){
