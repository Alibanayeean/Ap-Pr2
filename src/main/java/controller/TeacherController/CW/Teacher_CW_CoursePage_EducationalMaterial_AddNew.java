...
public class Teacher_CW_CoursePage_EducationalMaterial_AddNew implements Initializable {
    ...
    public void setTeacher(Teacher teacher, ClientNetwork clientNetwork, String courseId, LinkedList<EducationalMaterials> educationalMaterials, int index){
        ...
        for (int i = 0; i < educationalMaterials.get(index).getNumFiles(); i++) {
            items.add(educationalMaterials.get(index).getFileType().get(i) + "");
            addressesOrText.add(educationalMaterials.get(index).getAddressesInServerOrText().get(i));
            types.add(educationalMaterials.get(index).getFileType().get(i));
        }
        numAdds = educationalMaterials.get(index).getNumFiles();
    }
    ...
    public void SubmitFunction(ActionEvent event){
        ...
        educationalMaterials.get(index).setAddressesInServerOrText(addressesOrText);
        educationalMaterials.get(index).setFileType(types);
        educationalMaterials.get(index).setNumFiles(addressesOrText.size());
    ...
    public void backButtonFunction(ActionEvent e) {
        ...
        try{
            ...
            Teacher_CW_CoursePage_EducationalMaterial.setTeacher(teacher, clientNetwork, courseId, educationalMaterials, index);
