...
public class EducationalAssistant_ShowExams implements Initializable{
    public static final Logger log = LogManager.getLogger(EducationalAssistant_ShowExams.class);
