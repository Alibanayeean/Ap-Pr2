...
public class EducationalAssistant_GiveRecome implements Initializable {
    public static final Logger log = LogManager.getLogger(EducationalAssistant_GiveRecome.class);
