...
public class EducationalAssistant_ShowWeeklySchedule implements Initializable{

    public static final Logger log = LogManager.getLogger(EducationalAssistant_ShowWeeklySchedule.class);
