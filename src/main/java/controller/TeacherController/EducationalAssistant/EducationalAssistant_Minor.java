...
public class EducationalAssistant_Minor implements Initializable {
    public static final Logger log = LogManager.getLogger(EducationalAssistant_Minor.class);
...
//        LinkedList<Student> students = clientNetwork.FindStudentsWantsToMinor(teacher.getCollege() + "");
        ...
        for (int i = 0; i < students.size(); i++) {
            ...
            buttons[counter].setOnAction(event -> {
                ...
                if(alert.showAndWait().get() == ButtonType.OK){
                    if(students.get(m).getCollege() == teacher.getCollege()){
                        students.get(m).setFirstMinorStatus(MinorStatus.Accept);
                        clientNetwork.changeMinorStatusFromEA(true, students.get(m).getId(), "Accept");

                        log.info("minor accepted");


                    }
                    else if(students.get(m).getMinorCollege() == teacher.getCollege()){
                        students.get(m).setSecondMinorStatus(MinorStatus.Accept);
                        clientNetwork.changeMinorStatusFromEA(false, students.get(m).getId(), "Accept");

                        log.info("minor accepted");

                    }
//                    LinkedList<Student> students1 = clientNetwork.FindStudentsWantsToMinor(teacher.getCollege() + "");
//                    PrintForPane(students1);
            ...
            buttons[counter].setLayoutX(1175);
            ...
            buttons2[counter] = new Button("Rejcet");
            buttons2[counter].setOnAction(event -> {
                ...
                if(alert.showAndWait().get() == ButtonType.OK){
                    if(students.get(m).getCollege() == teacher.getCollege()){
                        students.get(m).setFirstMinorStatus(MinorStatus.Reject);
                        clientNetwork.changeMinorStatusFromEA(true, students.get(m).getId(), "Reject");


                        log.info("minor rejected");

                    }
                    else if(students.get(m).getMinorCollege() == teacher.getCollege()){
                        students.get(m).setSecondMinorStatus(MinorStatus.Reject);

                        clientNetwork.changeMinorStatusFromEA(false, students.get(m).getId(), "Reject");
...
//                    PrintForPane(students1);
            ...
            buttons2[counter].setLayoutX(1260);
    ...
    public void HelpPrint(int counter, Student student){
        ...
        Label labelForAverageScore = new Label();
        labelForAverageScore.setText(student.getMinorCollege() + "");
        labelForAverageScore.minHeight(187);
        labelForAverageScore.minWidth(31);
        labelForAverageScore.setLayoutX(857);
        labelForAverageScore.setLayoutY(12 + 80 * counter);
        labelForAverageScore.setFont(font);
        pane.getChildren().add(labelForAverageScore);
