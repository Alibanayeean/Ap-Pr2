...
public class BC_StudentEducationalStatus implements Initializable {
    public static final Logger log = LogManager.getLogger(BC_StudentEducationalStatus.class);
