...
public class Student_CW_CoursePage implements Initializable{
        ...
        for (int i = 0; i < educationalMaterials.size(); i++) {
            ...
            label.setOnMouseClicked(event -> {
                try{
                    ...
                    FXMLLoader loader = new FXMLLoader(getClass().getClassLoader().getResource("Fxml\\Student\\CW\\Student\\Student_CW_CoursePage_EducationalMaterial.fxml"));
                    Parent root = loader.load();
                    Student_CW_CoursePage_EducationalMaterial Student_CW_CoursePage_EducationalMaterial = loader.getController();
                    Student_CW_CoursePage_EducationalMaterial.setStudent(student, clientNetwork, courseId, educationalMaterials, m);
        ...
        for (int i = 0; i < homeWorks.size(); i++) {
            ...
            label.setOnMouseClicked(event -> {
                if(homeWorks.get(index).getHomeWorkOrExamType() == HomeWorkOrExamType.FILE){
                    if(isStarted(homeWorks.get(index).getBeginTime())){
    ...
    public void openCoursePageSendText(boolean isExam, LinkedList<Exam> exams, LinkedList<HomeWork> homeWorks, int index){
        ...
        try{
            stage = ((Stage)(((Scene)LogOutButton.getScene()).getWindow()));
            FXMLLoader loader = new FXMLLoader(getClass().getClassLoader().getResource("Fxml\\Student\\CW\\Student\\Student_CW_CoursePage_SendText.fxml"));
            Parent root = loader.load();
            Student_CW_CoursePage_SendText Student_CW_CoursePage_SendText = loader.getController();
            Student_CW_CoursePage_SendText.setStudent(student, clientNetwork, courseId, isExam, exams, homeWorks, index);
            Scene scene = new Scene(root);
            stage.setScene(scene);
            stage.show();
    ...
    public void openCoursePageSendFile(boolean isExam, LinkedList<Exam> exams, LinkedList<HomeWork> homeWorks, int index){
        ...
        try{
            stage = ((Stage)(((Scene)LogOutButton.getScene()).getWindow()));
            FXMLLoader loader = new FXMLLoader(getClass().getClassLoader().getResource("Fxml\\Student\\CW\\Student\\Student_CW_CoursePage_SendFile.fxml"));
            Parent root = loader.load();
            Student_CW_CoursePage_SendFile Student_CW_CoursePage_SendFile = loader.getController();
            Student_CW_CoursePage_SendFile.setStudent(student, clientNetwork, courseId, isExam, exams, homeWorks, index);
            Scene scene = new Scene(root);
            stage.setScene(scene);
            stage.show();
    ...
    public boolean isStarted(String begin){
