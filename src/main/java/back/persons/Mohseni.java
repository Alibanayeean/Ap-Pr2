...
public class Mohseni extends Person{
    String username;
    public Mohseni(int id, Color color, String image, String firstname, String lastname, String email, String password, String phoneNumber, String CodeMelli, College college, String username) {
