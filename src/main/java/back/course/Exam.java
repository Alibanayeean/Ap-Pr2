...
public class Exam {
    ...
    public Exam(int id, String name, String beginTime, String endTime, String addressOrTextQuestionInServer, HomeWorkOrExamType homeWorkOrExamType, String description) {
        this.id = id;
        this.name = name;
    ...
    public Exam(String name, String beginTime, String endTime, String addressOrTextQuestionInServer, HomeWorkOrExamType homeWorkOrExamType, String description) {
        this.name = name;
        this.beginTime = beginTime;
        this.endTime = endTime;
        this.addressOrTextQuestionInServer = addressOrTextQuestionInServer;
